# Get item detail from wowhead.com and save them to item_details.json
# Based on this post: https://www.wowhead.com/forums/topic/wowhead-api-for-items-characters-etc-187530
# Calls the wowhead item page by id and scrapes the XML for the item name and class, then saves all to
# item_details.json
